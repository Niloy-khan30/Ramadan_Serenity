...
const PrayerTracker = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setMessage("Prayer log saved successfully.");
        } catch (error) {
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-300 max-w-2xl mx-auto">
                        Track your daily prayers, save your worship progress, and view your
                        ...
                        {consistency ? (
                            <div className="space-y-4">
                                ...
                                <div className="bg-yellow-500/20 rounded-xl p-4 border border-yellow-400/20">
                                    ...
                                    <p className="text-2xl font-bold">{consistency.perfectDays}</p>
                                </div>
                                ...
                                <div className="bg-purple-500/20 rounded-xl p-4 border border-purple-400/20">
                                    ...
                                    <p className="text-2xl font-bold">{consistency.currentStreak}</p>
                                </div>
                                ...
                                <div className="bg-orange-500/20 rounded-xl p-4 border border-orange-400/20">
                                    <p className="text-sm text-gray-300">Average Per Day</p>
                                    <p className="text-2xl font-bold">
                                        {consistency.averagePrayersPerDay}
                                    </p>
                                </div>
                            </div>
                        ) : (
